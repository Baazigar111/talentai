...
const StatCard = ({ value, label, bg, color }: any) => (
  <div style={{
    ...
    <div className="metric-val" style={{
      fontFamily: 'Epilogue', fontWeight: 900, fontSize: '42px',
    ...
    <div style={{
      ...
      letterSpacing: '0.5px', color, opacity: 0.7, marginTop: '6px',
    }}>
      {label}
    </div>
  </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <h1 style={{
            ...
            fontSize: '36px', letterSpacing: '-1.5px', lineHeight: 1,
          }}>
            Dashboard
          </h1>
        </div>
      ...
      <div className="card" style={{ padding: '0', overflow: 'hidden' }}>
        ...
        {loading ? (
          <div style={{
            ...
            color: '#999', fontFamily: 'JetBrains Mono', fontSize: '12px',
          }}>
            Loading...
          </div>
        ) : jobs.length === 0 ? (
          <div style={{ padding: '40px', textAlign: 'center' }}>
            ...
            <Link href="/jobs" className="btn btn-yellow" style={{ fontSize: '12px' }}>
              Create First Job →
            </Link>
          </div>
        ) : (
          jobs.map((job, i) => (
            <div key={job.id} className="jobs-table-row" style={{
              display: 'grid', gridTemplateColumns: '1fr 120px 120px 100px',
            ...
            >
              <div>
                ...
                <div style={{
                  ...
                  marginTop: '2px', fontFamily: 'JetBrains Mono',
                }}>ID #{job.id}</div>
              </div>
              <div className="jobs-table-location" style={{ fontSize: '12px', color: '#555' }}>
                {job.location || '—'}
              </div>
              <div className="jobs-table-salary" style={{ fontSize: '12px', color: '#555' }}>
                {job.salary_range || '—'}
              </div>
      ...
      <div className="quick-links" style={{
        ...
        {[
          ...
          >
            <div style={{
              fontFamily: 'Epilogue', fontWeight: 900,
              fontSize: '15px', color: text, marginBottom: '4px',
            }}>{label}</div>
